...
document.addEventListener("DOMContentLoaded", () => {
    ...
    form.addEventListener("submit", async (e) => {
        ...
        try {
            ...
            // Sanitize pre-FEC string: strip ASCII control chars (tabs, newlines, etc.)
            // that cause monospace text to appear offset/centered in the display box.
            const sanitizeForDisplay = str =>
                str.replace(/[\x00-\x1F\x7F]/g, ' ').replace(/  +/g, ' ').trim();
...
<div class="comparison-container">
    <div class="comparison-column">
        ...
        <div class="comparison-box our-model" style="padding: 16px; border: 1px solid #bbf7d0; background: #edfdf1; border-radius: var(--rounded-lg);">
            ...
            <details style="margin-top: 6px; margin-bottom: 0; display: block;">
